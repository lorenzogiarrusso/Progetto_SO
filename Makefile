...
kernel : ./phase1/msg.o ./phase1/pcb.o ./phase2/exceptions.o ./phase2/interrupts.o ./phase2/main.o ./phase2/p2test.o ./phase2/scheduler.o ./phase2/ssi.o crtso.o libumps.o
	$(LD) -o $@ $^ $(LDFLAGS)
